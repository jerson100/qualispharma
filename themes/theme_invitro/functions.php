...
function register_my_menus()
{
    register_nav_menus(
        array(
            ...
            'sidebar-menu' => __('En la barra lateral'),
        )
    );
}
...
require_once get_template_directory() . '/inc/functions/productos.php';
require_once get_template_directory() . '/inc/functions/noticias.php';
...
if (function_exists('acf_add_options_page')) {
    ...
    acf_add_options_sub_page(
        array(
            'page_title' => 'Objetivos Principales',
            'menu_title' => 'Objetivos Principales',
            'parent_slug' => 'theme-general-settings'
        )
    );
    acf_add_options_sub_page(
        array(
            'page_title' => 'Lista de Partners',
            'menu_title' => 'Lista de Partners',
            'parent_slug' => 'theme-general-settings'
        )
    );
